...
public class WrappleClassreveiew {
...
methods: Max_values, MIN_values, parse methods, valueof methods
           ...
           parse methods: converts String to  string to int
           valueOf methods: converts string to wrapper class string to integer
...
//parse methods:    returns primitves, ignores the  the case sensitivity
   ...
   Double d2 = Double.parseDouble( "78.5"); //auto-boxing
       ...
       boolean r1 = Boolean.parseBoolean("TRUe") ; //none, trunun disinda ne yazarsan false
