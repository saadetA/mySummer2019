...
public class TenaryConditional {
	...
	public static void main(String[] args) {
		...
		/*
		 * if(isGreen) { action="can drive";
		 * 
		 * } else { action="can not drive"; }
		 */
...
//if(true){
		/*
		 * x=100; } else { x=20; } System.out.println(x); }
		 */
		int z = true ? 100 : 20;
		...
		/*
		 * if(true) { schoolname="cybertek"; } else { schoolname="invalid"; }
...
//or boolean passed=grade>=60?true:false;
		...
		group = Finalgrade == 'A' ? "earlybird" : Finalgrade == 'B' ? "Group 1" : "lastGroup";
		System.out.println(group);

		int k = 10000, k2 = 3000, k3 = 400;
		int c = (k > k2 && k2 < k3) ? k : (k2 > k && k < k3) ? k2 : k3;
