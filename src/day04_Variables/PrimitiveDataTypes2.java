...
public class PrimitiveDataTypes2 {
	/*
	Primitives:  byte, short, into, long, float, double, boolean , char
...
public static void main(String[] args) {
		...
		// initializing char to other primitives: byte, short, into, long, float, double
			char    MyChar1      =    'b';
			//    variablename         value
			
			int MyInt = MyChar1;  // the number that represents b is initialized to the into
