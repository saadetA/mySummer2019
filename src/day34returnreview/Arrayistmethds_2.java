...
import java. util.*;
public class Arrayistmethds_2 {
	/*
	 * remaining methods of arrayList: indexOf(object) : returns the index number of
	 * the object from the arrayList, retuns int lastIndexOf(Object): returns the
	 * last index number of the object from the arraylist, returns int
	 * Arrays.asList(Object Array): used for converting object arrays to List
	 * interface we will learn List Interface in future addAll(Interface): used for
	 * storing multiple objects to ArrayList
	 */
